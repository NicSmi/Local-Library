...
exports.book_delete_post = function(req, res){
    ...
    async.parallel({
        ...
        if (results.book_instance.length > 0) {
            ...
            res.render('book_delete', {title: 'Delete Book', book: book, book_instance: book_instance});
            return;
        }
        else {
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.render('book_form', {  title: 'Update Book', authors: results.authors, genres: results.genres, book, errors: errors.array() });
